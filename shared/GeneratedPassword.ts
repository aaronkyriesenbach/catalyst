import { Password } from "./imports/secretgen.k14s.io.ts";
import { Construct } from "npm:constructs";
import { SecretExport } from "./imports/secretgen.carvel.dev.ts";

export default class GeneratedPassword extends Password {
  constructor(scope: Construct, id: string, props: GeneratedPasswordProps) {
    const { name, length, exportNamespaces } = props;
