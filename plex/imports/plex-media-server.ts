...
export interface PlexmediaserverProps {
...
export class Plexmediaserver extends Construct {
  public constructor(scope: Construct, id: string, props: PlexmediaserverProps = {}) {
    super(scope, id);
    let updatedProps = {};
